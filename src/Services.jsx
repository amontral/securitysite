...
export default function Services({ onStartAssessment }) {
  return (
    <div style={styles.container}>
      <section style={styles.section}>
        <h1 style={styles.heading}>Our Consulting Services</h1>
        <p style={styles.text}>
      ...
      <section style={styles.ctaSection}>
        ...
        <div style={styles.buttonRow}>
          <button onClick={onStartAssessment} style={styles.ctaButton}>Take the SBSS Assessment</button>
